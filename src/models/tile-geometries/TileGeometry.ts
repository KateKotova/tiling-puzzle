...
export abstract class TileGeometry {
     ...
     * где точка (0; 0) - это координаты левого верхнего угла, а не точка опоры фигуры.
     * Направление обхода вершин должно быть по часовой стрелке! Это стандарт PixiJS.
     */
    public hitArea: Polygon = new Polygon();
    /**
     * Максимальный предельный размер фигуры.
     * Предельная сторона прямоугольной границы фигуры при любом угле поворота.
     */
    public maxBoundingSize: number = 0;
